...
import { R3InjectableMetadataFacade, getCompilerFacade } from '@nger/di.compiler';
import { Type } from '@nger/di.types';
import { NG_FACTORY_DEF } from '@nger/di.render3';
import { getClosureSafeProperty } from '@nger/di.util';
