...
import { ChangeDetectorRef } from '@nger/di.change_detection';
import { CompilerFacade, R3DependencyMetadataFacade, getCompilerFacade } from '@nger/di.compiler';
import { Type } from '@nger/di.types';
import { ReflectionCapabilities } from '@nger/di.reflection';
